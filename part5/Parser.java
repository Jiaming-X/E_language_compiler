...
//// Modification start here
    private void statement_list() {
    	while(is( TK.PRINT ) | is( TK.DO ) | is( TK.IF ) | is( TK.TILDE ) | is(TK.ID) | is(TK.FOR)){
    		statement();
    	}
    }
...
///////////////////////////////////////////////////////////////////////////////
 /// PART 5   
    ...
    private void declaration2(){
        ...
        mustbe(TK.DECLARE);
        if(is(TK.ID)){
            System.out.print( tok.string + scopelevel +  ";\nfor(" + tok.string + scopelevel);
        }
        aTable.addVariable(tok.string);
        mustbe(TK.ID);
        if(is(TK.ASSIGN)){
